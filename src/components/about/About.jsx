  ...
  return (
    <div name='about' className='w-full min-h-screen bg-gradient-to-b from-amber-50 to-white py-16'>
      <div className='max-w-7xl mx-auto px-4 sm:px-8'>
        {/* Section Header */}
        <div className='pb-12 w-full text-center space-y-4'>
          <span className='text-amber-900 text-sm font-medium tracking-widest uppercase'>About Me</span>
          <h2 className='text-4xl sm:text-5xl font-bold text-gray-800 mt-2'>Who I Am</h2>
          <div className='w-20 h-1 bg-amber-900/20 mx-auto'></div>
        </div>
